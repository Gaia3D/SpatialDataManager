...
/**
 * postgresql shape file import
 * 
 * @author hangum
 *
 */
public class PgsqlShapeFileImportDialog extends ShapeFileImportDialog {
	private static final Logger logger = Logger.getLogger(PgsqlShapeFileImportDialog.class);
	...
	public PgsqlShapeFileImportDialog(Shell parentShell, UserDBDAO userDB) {
