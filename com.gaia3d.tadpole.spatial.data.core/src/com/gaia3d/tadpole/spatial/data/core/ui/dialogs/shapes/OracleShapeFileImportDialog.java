...
/**
 * oracle shape file import
 * 
 * @author hangum
 *
 */
public class OracleShapeFileImportDialog extends ShapeFileImportDialog {
	private static final Logger logger = Logger.getLogger(OracleShapeFileImportDialog.class);
